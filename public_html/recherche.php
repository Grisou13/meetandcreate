...
/*
 * public_html/recherche.php
 * Description : Scirpt de recherche avancé
 * Auteur : Eric Bousbaa
 */ 
...
if($ajax){/*request est une requete utilisant typeahead*/
    switch($action)
    {
        ...
        case 'profil'://recherche d'un profil    
            ...
            break;
        case 'projet'://recherche d'un projet  
            ...
            break;
        default: //Query basic, renvoi tout
...
else{ /*Nous sommes sur la page de recherche avancé, il faut recherche les données comme pour ajax mais les afficher dans twig à la fin*/
    ...
    switch($action)
    {
        ...
        case 'tag'://recherche d'un tag
            ...
            break;
        default: //recherche avancé complete
